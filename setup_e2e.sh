...
install_diskdefs() {
    ...
    $SUDO sh -c "cat '$script_dir/wbw_hd512.diskdef' >> '$diskdef_file'"
...
install_romwbw() {
    ...
    local url="https://github.com/wwarthen/RomWBW/releases/download/v${ROMWBW_VERSION}/RomWBW-v${ROMWBW_VERSION}-Package.zip"
